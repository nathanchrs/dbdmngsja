...
return [
	...
	*/
	...
	"date"                 => ":attribute tidak mengandung tanggal yang valid.",
	...
	"max"                  => [
		...
		"array"   => ":attribute tidak boleh lebih banyak dari :max barang.",
	],
	...
	"min"                  => [
		...
		"array"   => ":attribute harus lebih banyak dari :min barang.",
	],
	"not_in"               => ":attribute yang terpilih tidak valid.",
	"numeric"              => ":attribute harus berupa sebuah angka.",
	"regex"                => "Format :attribute tidak valid.",
	"required"             => ":attribute harus diisi.",
	"required_if"          => ":attribute harus diisi jika :other diisi :value.",
	"required_with"        => ":attribute harus diisi jika :values terisi.",
	"required_with_all"    => ":attribute harus diisi jika terdapat :values.",
	"required_without"     => ":attribute harus diisi jika :values tidak ditemukan.",
	"required_without_all" => ":attribute harus diisi jika tidak ada dari :values ada.",
